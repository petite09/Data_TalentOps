...
![verificacion](IMG-P4/verificar_repo_rama.PNG)
...
![crear_rama](IMG-P4/crear_rama.PNG)
...
![modificacion_ventas](IMG-P4/modificacion_readme_ventas.PNG)
...
![modificacion_main](IMG-P4/modificacion_readme_main.PNG)
...
```
![merge_conflicto](IMG-P4/merge_conflicto.PNG)

Para ver los archivos que están generando conflicto usamos ``git status``.

![status_merge](IMG-P4/status_merge.PNG)
...
![conflicto_vscode](IMG-P4/conflicto_vscode.PNG)

Editamos el archivo para resolver el conflicto.

![solucionar_conflicto](IMG-P4/solucionar_conflicto.PNG)
...
```
![push_ramas](IMG-P4/push_ramas.PNG)
...
![comparar_ramas](IMG-P4/comparar_ramas.PNG)
...
![punto_final](IMG-P4/punto_final_readme.PNG)
...
![pr_rama](IMG-P4/pr_rama_ventas.PNG)
