...
2. Agregar clave al agente SSH:
    ...
    ![agente_SSH](IMG-P3/agente_ssh.PNG)
...
5. Probar Conexión
    ...
    ![conexion_exitosa](IMG-P3/conexion_exitosa.PNG)
...
6. Crear Repositorio Remoto (desde el repo local del día anterior)
    ...
    ![repo-vacio](IMG-P3/repositorio_vacio.PNG)
    ...
    ```
    ![crear_repo_remoto](IMG-P3/crear_repo_remoto.PNG)
...
7. Verificar que se puede hacer push y pull sin ingresar contraseña
    ...
    ```
    ![gitpull](IMG-P3/git_pull.PNG)

    ![gitpush](IMG-P3/git_push.PNG)
...
8. Verificar que los archivos locales se hayan subido al repositorio remoto de GitHub.
    ...
    ![repo_remoto](IMG-P3/repo_remoto.PNG)
